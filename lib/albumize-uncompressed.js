	...
	function Albumize(){
				...
				function AP(){
					...
					this.show_image = function(image_id, link){
						...
						console.log('before entering fresh image load: is a_overlay visible'+a_a_olay.is(":visible"));
						...
						if(!this.image_loaded[image_id]){
							...
							img.onload = function(){
								...
								console.log('entering image onload function: is a_overlay visible'+a_a_olay.is(":visible"));
								...
								a_pane.css({'top' : dst + 'px', 'left' : dsl + 'px'}).slideDown('slow');
									...
									console.log('leaving image onload function: is a_overlay visible'+a_a_olay.is(":visible"));
						...
						console.log('leaving image show function: is a_overlay visible'+a_a_olay.is(":visible"));
